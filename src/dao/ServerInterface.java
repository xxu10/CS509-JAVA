 ...
 */
	...
	public ArrayList<Integer> SeatsValid(String teamName, Departing departing){
        int first_valid ;
        int coach_valid ;
        ArrayList<Integer> seat_valid = new ArrayList<>();
    ...
    public Transfer1 Transfer_one(String teamName,Departing departing1,Departing departing2) {
		...
		transfer1.firstvalid1(ServerInterface.INSTANCE.SeatsValid(teamName, departing1).get(0));
		transfer1.coachvalid1(ServerInterface.INSTANCE.SeatsValid(teamName, departing1).get(1));
		...
		transfer1.firstvalid2(ServerInterface.INSTANCE.SeatsValid(teamName, departing2).get(0));
		transfer1.coachvalid2(ServerInterface.INSTANCE.SeatsValid(teamName, departing2).get(1));
		return transfer1;
	}
    ...
    public Transfer2 Transfer_twice(String teamName,Departing departing1,Departing departing2,Departing departing3) {
		...
		transfer2.firstvalid1(ServerInterface.INSTANCE.SeatsValid(teamName, departing1).get(0));
		transfer2.coachvalid1(ServerInterface.INSTANCE.SeatsValid(teamName, departing1).get(1));
		...
		transfer2.firstvalid2(ServerInterface.INSTANCE.SeatsValid(teamName, departing2).get(0));
		transfer2.coachvalid2(ServerInterface.INSTANCE.SeatsValid(teamName, departing2).get(1));
		...
		transfer2.firstvalid3(ServerInterface.INSTANCE.SeatsValid(teamName, departing3).get(0));
		transfer2.coachvalid3(ServerInterface.INSTANCE.SeatsValid(teamName, departing3).get(1));
		String firstclass1 = departing1.firstclass().substring(1);
		String firstclass2 = departing2.firstclass().substring(1);
    ...
    public boolean ticket_reserve_no(String teamName,ArrayList<Departing> transfer0){
		...
		Boolean databaseStauts = ServerInterface.INSTANCE.lock("DragonWarriors");
